...
function createCategoryDiv(categoryName) {
    ...
    categoryDiv.appendChild(songContainer)

    const playlistTitle = document.createElement('h3')
    playlistTitle.className = 'playlistTitle'
    titleDiv.appendChild(playlistTitle)
    ...
    titleDiv.appendChild(playlistOption)
...
function createSongBox(song, categoryDiv, songContainer) {
        ...
        .then(res => {
            ...
            for (const category in categories) {
                ...
                for (const subcategory of subCategories)
                    createSongBox(subcategory, categoryDiv, categoryDiv.querySelector('.song-container'))
            }
        })
